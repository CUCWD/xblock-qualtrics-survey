...
# https://stackoverflow.com/questions/53048792/equivalent-urllib-parse-unquote-in-python-2-7
try:
...
def parse_body_to_json(body_data):
    ...
    if body_data_json.get('CompletedDate') != "":
        body_data_json['CompletedDate'] = unquote(body_data_json['CompletedDate'])
